  ...
  return (
    <div className='flex justify-center items-center sm:px-6 lg:px-52 px-4 font-waheed sm:leading-loose sm:text-2xl text-2xl leading-10 mt-2'>
      <div className='pb-4 sm:px-0 sm:flex sm:flex-col w-full rounded bg-gray-100'>
        <h2 className='bg-customBlue flex items-center rounded px-4 leading-relaxed sm:px-0 text-3xl md:text-4xl md:h-40 h-52 mb-5'><Idea className='sm:h-20 h-24 inline mx-4' /> އިކި އިކި ސަރަހައްދުތެއް ތަރައްޤީކެރުމުގެ ޚިޔާލަ އަދި ކޮންސެޕްޓް</h2>
        ...
        <p className='text-gray-600 mt-2 px-4 sm:px-0 mx-auto'>ހާ އީމެއިލްކޯދިނުން އެދެން. ނުންވީ ތިރެއި މިވޭ ލިންކުތެކެން ފެނޮވާދިނުން އެދެން</p>
